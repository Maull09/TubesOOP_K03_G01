...
public class WinScreen extends JPanel {
    ...
    public WinScreen(GameGUI gameGUI) {
        this.gameGUI = gameGUI;
        initializeGUI();
        try {
            backgroundImage = new ImageIcon(getClass().getResource("/resources/images/background/41.png")).getImage();
        } catch (Exception e) {
    ...
    private void initializeGUI() {
        ...
        add(createButton("MainMenu", 535, 435, "/resources/images/background/mainMenu.png"));
    ...
    public static void main(String[] args) {
        ...
        WinScreen menu = new WinScreen(gameGUI);
